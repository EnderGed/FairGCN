...
from ModelGCN import EwSageN, CensGcnN
from consts import SEED


class CensEwSageN(EwSageN, CensGcnN):
    """
    Edge weightening with privacy censoring
    """

    fair_prefix = CensGcnN.fair_prefix + EwSageN.fair_prefix
    ...
    def __init__(self, data: dgl.DGLGraph, alpha: float, priv_lambda: float, hid_feats: int,
        ...
        """
        EwSageN.__init__(self, data=data, alpha=alpha, hid_feats=hid_feats, dropout=dropout, lr=lr,
