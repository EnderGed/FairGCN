...
from ModelGCN import EwAdSageN, CensAdGcnN, CensGcnN
from consts import SEED


class CensEwAdSageN(CensAdGcnN, EwAdSageN, CensGcnN):
    """
    Adversarial debiasing with Edge weightening and privacy censoring.
    """

    fair_prefix = CensGcnN.fair_prefix + EwAdSageN.fair_prefix
    ...
    def __init__(self, data: dgl.DGLGraph, ew_alpha: float, alpha: float, beta: float,
        ...
        """
        EwAdSageN.__init__(self, data=data, ew_alpha=ew_alpha, alpha=alpha, beta=beta, hid_feats=hid_feats,
