...
from ModelGCN import AdGcnN, EwSageN
from consts import SEED


class EwAdSageN(AdGcnN):
    """
    Edge weightening combined with Adversarial debiasing for GraphSAGE
    """
    ...
    def __init__(self, data: dgl.DGLGraph, ew_alpha: float, alpha: float, beta: float, hid_feats: int,
        ...
        ew = EwSageN(data=data, alpha=ew_alpha, hid_feats=hid_feats, dropout=dropout, lr=lr,
